...
export const portafolioData = [
  ...
  {
    imgSrc:
      "https://raw.githubusercontent.com/GUPILUAN/Pyng-Pong/refs/heads/main/screenshots/ss1.png",
    title: "Pyng-pong",
    skills: ["Python"],
    descripcion:
  ...
  {
    imgSrc:
      "https://www.servnet.mx/hubfs/Backend-y-Frontend-¿Qué-es-cómo-funcionan-en-la-programación.jpg",
  ...
  {
    imgSrc:
      "https://miro.medium.com/v2/resize:fit:1242/format:webp/1*UDOilEZZYakn48_tkIwi8Q.png",
  ...
  {
    imgSrc:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvroh2fw97L74U1maGrpTYvW5o8hzdGKTjQn8BDaP3vkp3Hjor4KW6z5Kbf5EvYc1LaU8&usqp=CAU",
...
export const getPortafolioData = (url: URL) => {
  ...
  return portafolioData.map((item) => {
    return {
      ...
      title: t(
        `portfolio.title.${item.title.toLowerCase().replace(/\s+/g, "-")}` ||
          item.title
      ),
      descripcion: t(
